...
async function extractGenesis3Words() {
  console.log('📖 창세기 3장 단어 추출 중...\n');

  // Get all words from Genesis chapter 3
  ...
  writeFileSync('genesis3_words.json', JSON.stringify(output, null, 2));
  console.log('✅ genesis3_words.json 파일에 저장 완료\n');
...
extractGenesis3Words().catch(console.error);
