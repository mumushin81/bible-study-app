/**
 * Insert Batch 1 etymology data into database
 */
...
async function insertBatch1() {
  console.log('🚀 Batch 1 어원 데이터 삽입 시작\n');
  console.log('━'.repeat(80) + '\n');

  // 1. JSON 파일 읽기
  const jsonPath = path.join(__dirname, 'batch1_complete_data.json');
  ...
  console.log('\n' + '━'.repeat(80));
  console.log('✨ Batch 1 삽입 완료!\n');
}

insertBatch1().catch(console.error);
