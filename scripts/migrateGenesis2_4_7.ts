...
async function deleteExistingData(verseIds: string[]) {
  ...
  await supabase.from('commentaries').delete().in('verse_id', verseIds);
  console.log(`   ✓ Commentaries 삭제 완료`);

  await supabase.from('words').delete().in('verse_id', verseIds);
...
async function main() {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🔄 Genesis 2:4-7 데이터 마이그레이션');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');

  try {
    const jsonPath = path.join(process.cwd(), 'data/genesis-2-4-7.json');
    ...
    console.log('📊 요약:');
    console.log(`   - Verses: ${verses.length}개 (Genesis 2:4-7)`);
