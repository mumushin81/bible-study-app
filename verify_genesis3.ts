...
async function verifyGenesis3() {
  console.log('🎯 창세기 3장 최종 확인\n');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

  const genesis3Data = JSON.parse(readFileSync('genesis3_words.json', 'utf-8'));
  const allWords = genesis3Data.words;
  ...
  console.log(`완성도: ${withSvg}/${allWords.length}\n`);

  if (withoutSvg > 0) {
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('⚠️  누락된 단어들:');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    missing.forEach((m, i) => {
      console.log(`${i + 1}. ${m}`);
    });
    ...
    console.log('\n🎉🎉🎉 축하합니다! 창세기 3장 모든 단어에 SVG가 있습니다! 🎉🎉🎉\n');
  }

  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
}

verifyGenesis3().catch(console.error);
