...
async function uploadGenesis2SVGs() {
  console.log('📦 창세기 2장 예술적 SVG 업로드 시작...\n');
  ...
  for (let batchNum = 1; batchNum <= 10; batchNum++) {
    console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(`📦 Genesis 2 Batch ${batchNum} 업로드 중...`);
    console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`);
...
uploadGenesis2SVGs().catch(console.error);
